...
#
# Examples:
#   scripts/send-voice-note.sh $ADMIN_CHAT_ID "Good morning! Here is your briefing."
#   scripts/send-voice-note.sh $ADMIN_CHAT_ID "$(cat /tmp/message.txt)"
#
# Requires:
...
if [ $# -lt 2 ]; then
    ...
    echo "Example: $0 $ADMIN_CHAT_ID \"Good morning! Here is your briefing.\"" >&2
    exit 1
fi
